...
<div class="container mx-auto p-6">
    <h2 class="text-2xl font-semibold mb-4">Rekap Absensi - {{ $jadwal->nama_mata_kuliah }}</h2>
    ...
    <table class="w-full table-auto">
        ...
        <tbody>
            ...
            <tr>
                <td class="border px-4 py-2">{{ $absen->mahasiswa->nama_lengkap ?? 'Mahasiswa tidak ditemukan' }}</td>
