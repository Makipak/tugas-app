...
<body class="bg-gradient-to-br from-gray-200 to-cyan-500 min-h-screen flex items-center justify-center p-4">
  <div class="bg-white/30 backdrop-blur-lg rounded-xl shadow-xl flex flex-col md:flex-row w-full max-w-5xl overflow-hidden">
    ...
    <div class="flex-1 bg-white/4 p-8 flex flex-col justify-center items-start text-white">
      ...
      <h2 class="text-4xl font-bold mb-4">Mahasiswa</h2>
      <p class="text-base">Isi data diri Anda sebagai mahasiswa untuk membuat akun absensi.</p>
    </div>

    <div class="flex-1 bg-white p-8 flex flex-col justify-center">
      <h3 class="text-2xl font-bold text-blue-600 mb-6 text-center">Registrasi Mahasiswa</h3>
      ...
      <form action="{{ route('register.mahasiswa') }}" method="POST">
        ...
        <div class="mb-4">
          ...
          <input type="username" id="username" name="username" value="{{ old('username') }}" placeholder="Username" required class="w-full border border-blue-600 rounded px-3 py-2 text-sm text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 @error('username') border-red-500 @enderror"/>
          @error('username')
        ...
        <div class="mb-4">
          <label for="nim" class="text-sm text-blue-600 block mb-1">NIM</label>
          <input type="text" id="nim" name="nim" value="{{ old('nim') }}" placeholder="nim" required class="w-full border border-blue-600 rounded px-3 py-2 text-sm text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 @error('nim') border-red-500 @enderror"/>
          @error('nim')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="mb-4">
          ...
          <input type="text" id="nama_lengkap" name="nama_lengkap" value="{{ old('nama_lengkap') }}" placeholder="Nama Lengkap" required class="w-full border border-blue-600 rounded px-3 py-2 text-sm text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 @error('nama_lengkap') border-red-500 @enderror"/>
          @error('nama_lengkap')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="mb-4">
          <label for="jurusan" class="text-sm text-blue-600 block mb-1">Jurusan</label>
          <input type="text" id="jurusan" name="jurusan" value="{{ old('jurusan') }}" placeholder="Jurusan" required class="w-full border border-blue-600 rounded px-3 py-2 text-sm text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 @error('jurusan') border-red-500 @enderror"/>
          @error('jurusan')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
          @enderror
        </div>
        ...
        <div class="mb-4">
          <label for="angkatan" class="text-sm text-blue-600 block mb-1">Angkatan</label>
          <input type="text" id="angkatan" name="angkatan" value="{{ old('angkatan') }}" placeholder="angkatan" required class="w-full border border-blue-600 rounded px-3 py-2 text-sm text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 @error('angkatan') border-red-500 @enderror"/>
          @error('angkatan')
            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
          @enderror
        </div>
